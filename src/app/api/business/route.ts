  ...
  try {
    ...
    const updatedBusiness = await prisma.business.update({
      ...
      data: {
        ...
        bookingInterval: bookingInterval !== undefined ? bookingInterval : business.bookingInterval,
        slotCapacity: slotCapacity !== undefined ? slotCapacity : business.slotCapacity,
        showPrices: showPrices !== undefined ? showPrices : business.showPrices,
        showDurations: showDurations !== undefined ? showDurations : business.showDurations,
        minBookingNotice: minBookingNotice !== undefined ? minBookingNotice : business.minBookingNotice,
        welcomeMessage: welcomeMessage !== undefined ? (welcomeMessage || null) : business.welcomeMessage,
        bufferTime: bufferTime !== undefined ? bufferTime : business.bufferTime,
        businessType: businessType !== undefined ? businessType : business.businessType,
        instagram: instagram !== undefined ? (instagram || null) : business.instagram,
        facebook: facebook !== undefined ? (facebook || null) : business.facebook,
