              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {business.instagram && (
                  <a
                    ...
                    className="flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:opacity-90 hover:scale-110 transition-all"
                  >
                ...
                {business.facebook && (
                  <a
                    ...
                    className="flex items-center justify-center w-9 h-9 rounded-full bg-[#1877F2] text-white hover:opacity-90 hover:scale-110 transition-all"
                  >
                ...
                {business.twitter && (
                  <a
                    ...
                    className="flex items-center justify-center w-9 h-9 rounded-full bg-black text-white hover:opacity-90 hover:scale-110 transition-all"
                  >
                ...
                {business.website && (
                  <a
                    ...
                    className="flex items-center justify-center w-9 h-9 rounded-full bg-primary text-white hover:opacity-90 hover:scale-110 transition-all"
                  >
